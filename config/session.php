...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When frontend and backend share the same domain (e.g. frontend at / and
    | backend at /riceadmin), set this to your domain with a leading dot so
    | the session cookie is sent for both: e.g. .amritsarspecials.com
    |
    */
