...
class SellQueriesINR extends Model
{
    ...
    protected $fillable = ['quality_type','quality','qualityForm','grade','packing','quantity','farming','offerPrice','validDays','packing_file','uncooked_file','cooked_file','contactperson','contactMobile','warehouselocation','created_by','remarks','status','type','extra_file','report_file'];
