...
class TradeController extends Controller
{
    ...
    public function index(){
        ...
        $activeBuyCount = TradeQueriesINR::whereIn('status', [6,4])->whereIn('tradeType', [1, 3])->count();
        $activeSellCount = TradeQueriesINR::whereIn('status', [6,4])->whereIn('tradeType', [2, 4])->count();
