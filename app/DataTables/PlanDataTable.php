...
class PlanDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->editColumn('sub_plan', function($model){
                ...
                $html = '<ul class="row" style="padding: 0; text-align: center;list-style: none">';
                    ...
                    $data[$model->plan_name]['ChartInt'] = ChartInterval::select('id', 'name')->whereIn('id' , array_values($chart_int))->get();
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('sub_plan')->title('sub_plan'),
            Column::make('chart_int')->title('chart_int')->class('chart_int'),
