...
// Route::group(['middleware' => 'cors'], function () {
    ...
    Route::get('get/carton/sizes' , ['as' => 'get.carton.sizes' , 'uses' => 'ApiController@getCartonSizes']);
    Route::get('get/cylinder/sizes' , ['as' => 'get.cylinder.sizes' , 'uses' => 'ApiController@getCylinderSizes']);
    ...
    Route::get('get/forwarder/charge-types' , ['as' => 'get.forwarder.charge.types' , 'uses' => 'ApiController@getForwarderChargeTypes']);
    ...
    Route::get('get/domestic-vendor/countries' , ['as' => 'get.domestic.vendor.countries' , 'uses' => 'ApiController@getDomesticVendorCountries']);
    Route::get('get/domestic-vendor/states/{countryId}' , ['as' => 'get.domestic.vendor.states.by.country' , 'uses' => 'ApiController@getDomesticVendorStates']);
    Route::get('get/domestic-vendor/states' , ['as' => 'get.domestic.vendor.states' , 'uses' => 'ApiController@getDomesticVendorStates']);
    Route::get('get/domestic-vendor/cities/{stateId}' , ['as' => 'get.domestic.vendor.cities.by.state' , 'uses' => 'ApiController@getDomesticVendorCities']);
    Route::get('get/domestic-vendor/cities' , ['as' => 'get.domestic.vendor.cities' , 'uses' => 'ApiController@getDomesticVendorCities']);
    Route::get('get/domestic-vendor/destinations' , ['as' => 'get.domestic.vendor.destinations' , 'uses' => 'ApiController@getDomesticVendorDestinations']);
    Route::get('get/domestic-vendor/truck-sizes' , ['as' => 'get.domestic.vendor.truck.sizes' , 'uses' => 'ApiController@getDomesticVendorTruckSizes']);
    ...
    Route::get('list/web/paddy/crop-years', ['as' => 'list.web.paddy.crop.years.api', 'uses' => 'PaddyApiController@listPaddyTradeCropYears', 'middleware' => 'portal.api.token']);
