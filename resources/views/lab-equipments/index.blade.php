    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Vendor Flow</li>
                <li class="active">Lab Equipment</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Lab equipment master</h3>
                            <div class="pull-right">
                                <a href="{{ route('create.lab-equipment') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tbody>
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    @if((int) $record->status === \App\LabEquipment::STATUS_ACTIVE)
                                                ...
                                                <td>
                                                    @include('lab-equipments._actions', ['model' => $record])
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
