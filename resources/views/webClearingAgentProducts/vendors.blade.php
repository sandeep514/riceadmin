...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Clearing Agent Vendors
            <small>List</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)"><i class="fa fa-dashboard"></i> Home</a></li>
            <li>Service Providers</li>
            <li class="active">Clearing Agent Vendors</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <table class="table table-striped table-bordered" id="clearingAgentVendorsTable" width="100%">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Vendor</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center text-muted">No clearing agent vendors found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
...
<script>
    $(function () {
        $('#clearingAgentVendorsTable').DataTable({
            pageLength: 25,
            order: [[0, 'desc']],
