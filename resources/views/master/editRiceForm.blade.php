            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        {!! Form::open(['route'=>'master.update.rice.type']) !!}
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        {!! Form::label('riceType','Rice Type*') !!}
                                        <select class="form-control" name="riceType">
                                            <option {{ ($riceForm->type == "basmati") ? 'selected' : '' }} value="basmati">Basmati</option>
                                            <option {{ ($riceForm->type == "non-basmati") ? 'selected' : '' }} value="non-basmati">Non Basmati</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4 ">
