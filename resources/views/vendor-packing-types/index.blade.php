                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Bag type master</h3>
                                        ...
                                        @foreach($records as $record)
                                            <tr>
                                                <td data-order="{{ $record->order_no ?? 999999 }}">
                                                    @include('components.master-order-input', ['model' => $record, 'route' => 'update.order.vendor-packing-type'])
                                                </td>
                                                <td>{{ $record->name }}</td>
...
<script>
    $(function(){
        ...
        $(document).on('click', '.delete-row', function(e){
            e.preventDefault();
            if(confirm('Are you sure you want to delete this bag type?')){
