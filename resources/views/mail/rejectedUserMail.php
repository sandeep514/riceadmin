...
<body>
  ...
  <div class="email-wrapper">
    ...
    <div class="content">
      <p>
        Dear <strong><?php echo $userName ?? 'User' ?></strong>,
      </p>
      <p>
        Your SNTC account is on hold due to <strong> <?php echo $mailmessage; ?> </strong>.Please do the needful changes to activate the account.
      </p>
      <br>
      <p>
