...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('get.web.machinery.equipment.products.list') }}">Machinery Equipment Products</a></li>
    ...
    <section class="content">
        <div class="box-body">
            <div class="row text-left" style="margin-top: 20px;">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered" id="machineryEquipmentProductsTable" width="100%">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Owner</th>
                        ...
                        <tbody>
                            @foreach($products as $product)
                                ...
                                <tr>
                                    ...
                                    <td style="white-space:nowrap;">
                                        <a class="btn btn-sm btn-primary" href="{{ route('get.web.machinery.equipment.products.show', $product->id) }}">
                                            <i class="fa fa-eye"></i> View
                                        </a>
                                        @include('components.vendor-product-status-actions', [
                                            'product' => $product,
                                            'route' => 'toggle.web.machinery.equipment.products.status',
                                            'kind' => 'machinery_equipment',
                                        ])
                                    </td>
                                </tr>
                            @endforeach
...
<script>
    $(function () {
        $('#machineryEquipmentProductsTable').DataTable({
            pageLength: 25,
            order: [[0, 'desc']],
