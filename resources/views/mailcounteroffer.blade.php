<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <!-- <p>You got a new counter update, bid's serial no = {{ $sno }} & Title = {{ $QualityName }}</p> -->
    <p>{{ $userData->name }} {{ ( $userData->email , $userData->mobile ) }} accept the counter offered. Please visit the portal.</p>
