    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Masters</li>
                <li class="active">Destination Regions</li>
            </ol>
        </section>
                                    ...
                                    <tbody>
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    @if((int) $record->status === \App\VendorDestinationRegion::STATUS_ACTIVE)
                                                ...
                                                <td>
                                                    @include('vendor-destination-regions._actions', ['model' => $record])
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
...
<script>
    $(function(){
        ...
        $(document).on('click', '.delete-row', function(e){
            e.preventDefault();
            if(confirm('Are you sure you want to delete this Destination region?')){
