<div class="box-body">
    <div class="row">
        <div class="form-group col-md-6 @error('charge') has-error @enderror">
            {!! Form::label('charge', 'Charge*') !!}
            {!! Form::text('charge', null, ['class' => 'form-control', 'id' => 'charge', 'maxlength' => 255, 'placeholder' => 'Enter charge']) !!}
            @error('charge')
