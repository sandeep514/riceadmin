    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('documents') }}">Vendor Category Master</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Vendor Category Master</h3>
                        </div>
                        <!-- /.box-header -->
                        {!! Form::open(['route'=>'vendor.category.master.save','files'=>true]) !!}
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-6">
