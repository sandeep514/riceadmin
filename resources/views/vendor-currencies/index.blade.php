                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Currency master</h3>
                            <div class="pull-right">
                                <a href="{{ route('create.vendor-currency') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tbody>
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    @if((int) $record->status === \App\VendorCurrency::STATUS_ACTIVE)
                                                ...
                                                <td>
                                                    @include('vendor-currencies._actions', ['model' => $record])
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
