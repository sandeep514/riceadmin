...
class CreateFutureSellQueryMilestone3Table extends Migration
{
    public function up()
    {
        Schema::create('future_sell_query_milestone3', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('future_sell_query_milestone3');
    }
}
