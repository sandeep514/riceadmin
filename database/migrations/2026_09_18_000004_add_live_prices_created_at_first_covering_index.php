...
class AddLivePricesCreatedAtFirstCoveringIndex extends Migration
{
    public function up()
    {
        $this->addIndexIfMissing(
            'live_prices',
            'idx_live_prices_created_at_first',
    ...
    {
        $this->dropIndexIfExists('live_prices', 'idx_live_prices_created_at_first');
    }
